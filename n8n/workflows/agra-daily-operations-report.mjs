...
const schedule = trigger({
  ...
  config: {
    ...
    parameters: { rule: { interval: [{ field: 'days', daysInterval: 1, triggerAtHour: 17, triggerAtMinute: 0 }] } },
    position: [240, 300],
  },
});
...
export default workflow('agra-daily-operations-report', 'Agra - Daily Operations Report')
  .add(schedule)
  .to(signIn)
  .to(runMonitor);
